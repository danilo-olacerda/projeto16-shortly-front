...
export default function Login() {
    ...
    function register(e){
        ...
        const promise = axios.post("https://danilo-shortly.herokuapp.com/signin", body);
        setEnable(true);
    ...
    return (
        <Container>
            ...
            <form action="submit" onSubmit={register}>
                ...
                <button type="submit" disabled={enable}>{enable ? <ThreeDots color="#FFFFFF" height={20} width={50} /> : "Entrar"}</button>
            </form>       
        </Container>
    )
}
